...
function theme_mb2nl_hrintro( $text, $novideo = false )
{
	...
	$isvideocontent = theme_mb2nl_get_video_shortcode($text);
...
function theme_mb2nl_is_videopost($post)
{
	...
	$isvideocontent = theme_mb2nl_get_video_shortcode($introtext);
...
function theme_mb2nl_blog_featuredmedia($post)
{
	...
	elseif ( $isvideo == 2 )
	{
		$isvideocontent = theme_mb2nl_get_video_shortcode(str_replace('"]', '" ]', $introtext ));
