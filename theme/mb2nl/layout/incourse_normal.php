...
$sidebar = theme_mb2nl_isblock($PAGE, 'side-pre') || theme_mb2nl_is_toc();
$sidebarPos = theme_mb2nl_theme_setting($PAGE, 'sidebarpos');
        ...
        <div class="row">
            ...
            <?php if ($sidebar) : ?>
                <section class="sidebar-col <?php echo $sideCol; ?>">
                    <?php if ( theme_mb2nl_theme_setting($PAGE, 'coursetoc') ) : ?>
