...
?>
<div class="course-header dark" style="background-image:url('<?php echo theme_mb2nl_get_enroll_hero_url(); ?>')">
	<div class="inner">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						...
						<a href="#page-content" class="btn btn-xlg btn-primary course-enrolbtn fwmedium"><?php echo $enrolbtntext; ?></a>
					</div>
				</div>
			</div>
		</div>
